...
# load MD with frames
mol new {../renumberedBDvmdwritten4ins7.gro} type {gro}
set miMD [lindex [molinfo list] end]
set nf [expr double([molinfo $miMD get numframes])]
set nfmo [expr $nf-1.0]

set unsortedHBlist [open "../Results/SortCountHB/Sorted_chain_AllHB_ht_0%_nrHBs_87.dat" r]
...
mol modcolor $mnr $miMD ColorID 13
mol modmaterial $mnr $miMD Transparent

incr mnr
mol addrep $miMD
mol modselect $mnr $miMD "protein and resid 52 to 72"
mol modstyle $mnr $miMD NewCartoon 0.180000 10.000000 4.100000 0 
...
mol modstyle $mnr $miMD NewCartoon 0.180000 10.000000 4.100000 0 
mol modcolor $mnr $miMD ColorID 20
mol modmaterial $mnr $miMD Transparent

incr mnr
mol addrep $miMD
mol modselect $mnr $miMD "protein and resid 73 to 102"
mol modstyle $mnr $miMD NewCartoon 0.180000 10.000000 4.100000 0 
